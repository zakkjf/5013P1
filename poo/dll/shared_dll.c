...
/**
​ ​*​ ​@file​ ​dll.c
​ ​*​ ​@brief​ ​Shared-Memory Doubly-linked list source
​ ​*
...
{
    Node * head = mmap(NULL, sizeof(Node), PROT_READ | PROT_WRITE, MAP_ANONYMOUS | MAP_SHARED, 0, 0);
